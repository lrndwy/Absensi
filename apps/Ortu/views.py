...
def ortu_dashboard(request):
    ...
    jam_masuk = instalasi.jam_masuk_siswa if instalasi else None
    ...
    return render(request, 'Ortu/ortu_dashboard.html', context)

@login_required
@ortu_required
def ortu_statistik(request):
...
def ortu_pengaturan(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('ortu_pengaturan')
    ...
    return render(request, 'Ortu/ortu_pengaturan.html', context)
